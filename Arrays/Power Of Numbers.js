/*
Medium - Given a number n, find the value of n raised to the power of its own reverse.
...
class Solution {
    ReverseExponentiation(n) {
        // code here
        let reversedN=parseInt(n.toString().split('').reverse().join(''),10);
        let result=Math.pow(n,reversedN);
        return result;
